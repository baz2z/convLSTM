...
python ./trainSpeed.py --run_idx ${SLURM_ARRAY_TASK_ID} --model "depthWise" --dataset "wave" \
                   --mode "speed/notNormalized/adapted/20-70" --context 20 --horizon 70 --learningRate 0.001 \
