...
python ./trainClip.py --run_idx ${SLURM_ARRAY_TASK_ID} --model "depthWise" --datasetTrain "wave-10-1-3-290" \
                   --datasetVal "wave-10-1-3-290" --mode "clip" --context 20 --horizon 40 --learningRate 0.001 \
