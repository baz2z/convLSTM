#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --array=0-2                              # Number of tasks (see below)
...
#SBATCH --output=svolz_%j.out               # File to which STDOUT will be written
#SBATCH --error=svolz_%j.err               # File to which STDERR will be written
