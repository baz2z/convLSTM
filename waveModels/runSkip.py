...
if __name__ == '__main__':
    ...
    run = args.run_idx
    seq, modelName = Forecaster(12, skipConnection, num_blocks=2, lstm_kwargs={'lateral_channels': 12}).to(device), "skip"
    batch_size = 32
    epochs = 250
    learningRate = 0.0001
    ...
    os.chdir("../trainedModels/wave/horizon-20-70/skip/run" + str(run))
