...
if __name__ == '__main__':
    ...
    run = args.run_idx
    seq, modelName = Forecaster(12, twoLayer, num_blocks=2, lstm_kwargs={'lateral_channels': 12}).to(device), "twoLayer"
    batch_size = 32
    epochs = 5
    learningRate = 0.0001
    ...
    os.chdir("../trainedModels/wave/horizon-20-70/twoLayer/run" + str(run))
