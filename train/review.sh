#!/bin/bash
#SBATCH --ntasks=3
#SBATCH --array=1-3                         # Number of tasks (see below)
...
python ./trainFuture.py --run_idx ${SLURM_ARRAY_TASK_ID} --model "lateral" --datasetTrain "wave-10-1-3-290" \
                   --datasetVal "wave-10-1-3-290" --mode "future-adapted/20" --context 20 --horizon 70 --learningRate 0.001 \
                   --epochs 1 --batchSize 32 --multiplier 1 --paramLevel 2 --clip 1 --start 100
